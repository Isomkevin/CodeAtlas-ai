...
from app.modules.mcp_http.sse import router as mcp_sse_router
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app.add_middleware(
        ...
        or [str(resolved_settings.web_app_origin).rstrip("/")],
    ...
    app.include_router(mcp_sse_router, prefix=resolved_settings.api_v1_prefix)
